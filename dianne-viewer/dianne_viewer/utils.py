...
def viewSTQ(dpath, imfname='image.ome.tiff', load_features=False, samples=None, F=2, model='ctranspath',
            ...
            template2='features/false-{F}-{model}_features.tsv.gz', mpp=None, save_path=None, username='auto'):
    ...
    Args:
        ...
        username (str): The username to be used for the viewer.
    Returns:
    ...
    if load_features:        
        ...
        return create_viewer(valid_samples, imgs, height=height, sample_metadata=sample_metadata_, mpp=mpp, save_path=save_path, username=username)[1]
...
def viewSTQkomp(dataPath, samples, F=2, model='ctranspath', color='lime', patch_size=8, PCMA_alpha=0.8, multiplier=2,
    ...
    drawings = create_viewer(samples, imgs, height="800px", run_inference_fn=runfn, sample_sizes=sizes,
                                    ...
                                    save_func=savefn, load_func=loadfn, list_names_func=listfn,
                                    sample_metadata=sample_metadata, mpp=mpp, save_path=save_path, username=username)[1]
    return drawings


def viewMIQ(dpath, imfname='adjusted-all-channels.ome.tif', samples=None, height="800px",
            mpp=0.2125, max_cells=10000, username='auto'):
